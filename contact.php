	...
	<?php include "scr-header.php"; ?>
		<body>	
		  <?php include "navbar.php";?>
			...
			<!-- start banner Area -->
			<section class="banner-area banner-area-contact relative" id="home">	
							...
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									...
									<p>
										Alex Arment
										<br>
										<a href="mailto:Alexandra.C.Arment-1@ou.edu">Email</a>
										<br>
							...
							<div class="single-contact-address d-flex">	
								...
								<div class="contact-details">
									...
									<p>
										Ian Kennedy
										<br>
										<a href="mailto:ian.j.kennedy-1@ou.edu">Email</a>
										<br>
							...
							<div class="single-contact-address d-flex">
								...
								<div class="contact-details">
									...
									<p>
										Tyler Julian
										<br>
										<a href="mailto:tyler.james.julian@ou.edu">Email</a>
										<br>
										<i>Electrical Engineering</i>
									</p>
								</div>
