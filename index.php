					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">2020 Information</h1>
								<p>
									<h3><a href="https://www.youtube.com/watch?v=GgFgsHBuArI">Welcome Video</a></h3>
									<h3><a href="content/SCR_Info_Session_2020-2021.pdf">Camp Crimson PDF</a></h3>
								</p>
							</div>
						</div>
					</div>
